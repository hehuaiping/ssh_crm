									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#page.list" var="cust" >
												<TR id="cust<s:property value="#cust.cust_id" />"
													...
													<TD>
													<s:property value="#cust.cust_user_id" />
													</TD>
													<TD>
													...
													<c:if test="${param.select ne true}">
														<a href="${pageContext.request.contextPath }/CustomerAction_editCustomer?cust_id=<s:property value="#cust.cust_id" />">修改</a>
														&nbsp;&nbsp;
														<a href="javascript:void(0)" onclick="confirmDelete(${cust_id},'cust${cust_id}')">删除</a>
													</c:if>
