							...
							<TBODY>
								<TR>
									<TD height=25>	
										...
										action="${pageContext.request.contextPath }/SaleVisitAction_getSaleVisitList"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														<input type="text" readonly="readonly" style="WIDTH: 180px" name="cust_name"  id="cust_name" value="${param['cust_name']}" />
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#page.list" var="sv" >
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD><s:property value="#sv.user.user_name" /></TD>
													<TD><s:property value="#sv.customer.cust_name" /></TD>
													<TD><s:property value="#sv.visit_time_s" /></TD>
													<TD><s:property value="#sv.visit_interviewee" /></TD>
													<TD><s:property value="#sv.visit_addr" /></TD>
													<TD><s:property value="#sv.visit_detail" /></TD>
													<TD><s:property value="#sv.visit_nexttime_s" /></TD>
													<TD>
															<!-- 没有传递参数,显示删除和修改操作 -->
														<a href="${pageContext.request.contextPath }/SaleVisitAction_editSaleVisit?visit_id=<s:property value="visit_id" />">修改</a>
														&nbsp;&nbsp;
