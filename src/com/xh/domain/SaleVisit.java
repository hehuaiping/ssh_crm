...
//	private Long visit_user_id        ;
	...
	public String getVisit_time_s() {
		return datefromString(getVisit_time(), "yyyy年MM月dd日");
	}
	public String getVisit_nexttime_s() {
		return datefromString(getVisit_nexttime(), "yyyy年MM月dd日");
	}
	//格式化时间
	public String datefromString(Date date , String format) {
